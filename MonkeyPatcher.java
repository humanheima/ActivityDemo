    ...
    public static void monkeyPatchExistingResources(@Nullable Context context,
        ...
        */
        try {
            ...
            if (activities != null) {
                for (Activity activity : activities) {
                    ...
                    try {
                        ...
                        //通过反射获取Resources类中ResourcesImpl类型的对象ResourcesImpl
                        Field mResourcesImpl = Resources.class.getDeclaredField("mResourcesImpl");
                        mResourcesImpl.setAccessible(true);
                        Object resourceImpl = mResourcesImpl.get(resources);
                        //获取resourceImpl对象中的AssetManager类型的对象mAssets
                        Field implAssets = resourceImpl.getClass().getDeclaredField("mAssets");
                        implAssets.setAccessible(true);
                        //将resourceImpl替换为newAssetManager
                    ...
                    try {
                        try {
                            ...
                            //通过反射获取ResourcesImpl.ThemeImpl类型的对象mThemeImpl
                            Field themeField = Resources.Theme.class.getDeclaredField("mThemeImpl");
                            themeField.setAccessible(true);
                            Object impl = themeField.get(theme);
                            //获取AssetManager类型对象 mAssets
                            Field ma = impl.getClass().getDeclaredField("mAssets");
                            ma.setAccessible(true);
                            //将ma替换为newAssetManager
            ...
            //根据SDK版本，获取Resources的弱引用集合，然后遍历集合，将集合中Resources的mAssets更新为newAssetManager
            // Iterate over all known Resources objects
            ...
            //更新Resources的mAssets字段，或者ResourcesImpl的mAssets字段
